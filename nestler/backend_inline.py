...
def get_do_display(backend):
    return backend.shell.ast_node_interactivity != 'none'
...
def show(close=None, block=None):
    ...
    do_display = get_do_display(backend)

    if close is None:
        close = backend.close_figures
    try:
